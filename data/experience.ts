...
export const experience: ExperienceEntry[] = [
  {
    ...
    description:
      "Lead data science initiatives for a consumer fintech lending platform, owning credit risk modeling and ML infrastructure for the Flexible Rent product line and a new training pipeline for the core personal loan credit risk model.",
    bullets: [
      ...
      "Constructed lagged and differenced features to surface momentum signals such as improving payment behavior or deteriorating cash reserves. Increased Gini coefficient by 23%.",
      "Designed Metaflow pipelines to automate the challenger model lifecycle for the primary credit risk underwriting model, accelerating experiment-to-production velocity.",
      "Trained a team of 3 other Data Scientists to contribute flows to the project.",
      "Built a RAG-based chat system over internal documentation with a Snowflake integration for natural-language SQL queries, reducing time-to-insight for non-technical stakeholders.",
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Built a centralized data lake using PySpark to ingest real-time data from DynamoDB, RDS, S3, and Athena, replacing previously siloed EC2 internal datasets.",
